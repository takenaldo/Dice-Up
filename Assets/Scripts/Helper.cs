...
public class Helper : MonoBehaviour
{
    ...
    public static string USER_HIGH_SCORE = "user_level";
...
//        if ((lvl) <= PlayerPrefs.GetInt(Helper.USER_LEVEL, 1))
    ...
    {
        LoadScene("Level" + (PlayerPrefs.GetInt(Helper.USER_HIGH_SCORE, 1)));
    }

    public static int getHighScore()
    {
        return PlayerPrefs.GetInt(Helper.USER_HIGH_SCORE, 0);
    }

    public static void setHighScore(int newHighScore)
    {
         PlayerPrefs.SetInt(Helper.USER_HIGH_SCORE, newHighScore);
    }
 ...
 /*   public void loadNextLevel()
    {
        LoadLevel(GameManager.instance.current_level + 1);
    }
